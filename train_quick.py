#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FAST single-LGB OOF check for ROGII (feature/param experiments).
# Run on Kaggle (needs the competition data; attach the v5 feature-cache dataset to skip the ~2.8h build).

# ======================================================================
# FAST single-LGB OOF check for ROGII — feature/parameter experiments.
...
# ======================================================================
# ===== quick single-LGB OOF (feature/param experiments) =====
import gc
import numpy as np
from sklearn.model_selection import GroupKFold
